      ...
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 space-y-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-2xs space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {componentsList.map((comp, idx) => (
                <div 
                  key={idx} 
                  className="p-5 bg-slate-50/90 rounded-2xl border border-slate-200 flex flex-col justify-between space-y-3 hover:border-slate-300 transition-colors"
                >
        ...
        {project.architecture_url && (
          <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-2xs space-y-4">
            ...
            <div className="w-full rounded-2xl overflow-hidden border border-slate-200 bg-slate-950 flex items-center justify-center p-6">
              <img 
